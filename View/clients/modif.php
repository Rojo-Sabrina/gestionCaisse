            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="Controller/clientsController.php">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        name="id_clients" readonly="readonly" value="<?php echo $ligne[0]?>">
                      </div>
                    </div>

                    <div class="col-12">
                      <label for="libelle" class="form-label">Nom client</label>
                      <input type="text" class="form-control" id="libelle" required
                      name="nom"  value="<?php echo $ligne[1]?>">
                    </div>

                    <div class="col-12">
                      <label for="nombre" class="form-label">Contact</label>
                      <input type="text" class="form-control" id="nombre" required
                      name="contact"  value="<?php echo $ligne[2]?>">
                    </div>

                    <div class="col-12">
                      <label for="nombre" class="form-label">Adresse</label>
                      <input type="text" class="form-control" id="nombre" required
                      name="adresse"  value="<?php echo $ligne[3]?>">
                    </div>
