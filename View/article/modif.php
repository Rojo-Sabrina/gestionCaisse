            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="Controller/articleController.php">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        name="id_article" readonly="readonly" value="<?php echo $ligne[0]?>">
                      </div>
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Code Article</label>
                      <input type="text" class="form-control" id="yourPassword" required
                      name="code_barre"  value="<?php echo $ligne[1]?>">
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Nom article</label>
                      <input type="text" class="form-control" id="yourPassword" required
                      name="nom_article" value="<?php echo $ligne[2]?>">
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Prix unitaire</label>
                      <input type="text" class="form-control" id="yourPassword" required
                      name="prix_unitaire" step="1000" value="<?php echo $ligne[3]?>">
                    </div>
