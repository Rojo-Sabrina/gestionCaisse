            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="Controller/bonsortieController.php">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        name="num_bonsortie" readonly="readonly" value="<?php echo $ligne[0]?>">
                      </div>
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">N° bon de sorite</label>
                      <input type="number" class="form-control" id="yourPassword" required
                      name="numbs"  value="<?php echo $ligne[1]?>">
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Date</label>
                      <input type="date" class="form-control" id="yourPassword" required
                      name="date_bonsortie"  value="<?php echo $ligne[2]?>">
                    </div>

                    <div>
                <label>Clients</label>
                <select class="form-select" name="id_clients">
                    <option value="">Choisissez le clients</option>
                    <?php
