            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="Controller/entrerController.php">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        name="id_entrer" readonly="readonly" value="<?php echo $ligne[0]?>">
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Date d'entrée</label>
                      <input type="date" class="form-control" id="yourPassword" required
                      name="date_entree" value="<?php echo $ligne[2]?>">
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Date de péremption</label>
                      <input type="date" class="form-control" id="yourPassword" required
                      name="date_peremption" value="<?php echo $ligne[3]?>">
                    </div>
            ...
            <div>
                ...
                <select class="form-select" name="id_article">
                    ...
                    <?php
                        ...
                        $lisc = listArticle();
                        while ($cligne = mysqli_fetch_row($lisc)) {
                            echo "<option value='$cligne[0]'>$cligne[2]</option>";
                        } 
                    ?>
                </select>           
            </div>
