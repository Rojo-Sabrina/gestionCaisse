            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="Controller/utilisateurController.php">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        name="id_utilisateur" readonly="readonly" value="<?php echo $ligne[0]?>">
                      </div>
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Nom utilisateur</label>
                      <input type="text" class="form-control" id="yourPassword" required
                      name="nom"  value="<?php echo $ligne[1]?>">
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Prénom</label>
                      <input type="text" class="form-control" id="yourPassword" required
                      name="prenom"  value="<?php echo $ligne[2]?>">
                    </div>

                    <div class="col-12">
                    <label for="inputNanme4" class="form-label">type</label>
                    <select class="form-control" id="inputNanme4" name="type" value="<?php echo $ligne[3]?>">
                    ...
                    <div class="col-12">
                      ...
                      name="mot_de_passe"  value="<?php echo $ligne[4]?>">
                    </div>
                    <div class="col-12">
