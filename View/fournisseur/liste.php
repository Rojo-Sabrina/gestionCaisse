                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Formulaire d'ajout de fournisseur</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                            <!--formulaire ajout-->
                            <form class="row g-3" method="POST" action="Controller/fournisseurController.php">
                                <div class="col-12">
                                <label for="inputNanme4" class="form-label">Nom fournisseur</label>
                                <input type="text" class="form-control" id="inputNanme4" name="nom_fournisseur">
                                </div>
                                ...
                                <input type="text" class="form-control" id="inputNanme4" name="contact">
                                </div>
            ...
            <tr>
                <?php
                    while ($svg = mysqli_fetch_row($link)) {
                        ...
                        <td>$svg[2]</td>
                        <td>$svg[3]</td>
                        <td><a href= 'Controller/fournisseurController.php?id_fournisseur=$svg[0]'
                        onclick ='return confirmation();'> <img src='assets/img/supprimer.jpg' width='50' height='50'>
                        </a></td>
                        <td><a href='?ok=editfou&id_fournisseur=$svg[0]'><img src='assets/img/icone modifier.jpg' width='50' height='50'>
                        </a></td>
                            </tr>";
                    }
                ?>              
