            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="Controller/categorieController.php">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        name="id_categorie" readonly="readonly" value="<?php echo $ligne[0]?>">
                      </div>
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Catégorie</label>
                      <input type="text" class="form-control" id="yourPassword" required
                      name="nom_categorie"  value="<?php echo $ligne[1]?>">
                    </div>
                    <div class="col-12">
