...
<div class="row">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Liste des presentation</h5>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Formulaire d'ajout de présentation</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                            <!--formulaire ajout-->
                            <form class="row g-3" method="POST" action="Controller/presentationController.php">
                                <div class="col-12">
                                <label for="inputNanme4" class="form-label">Libellés</label>
            ...
            <tr>
                <?php
                    while ($svg = mysqli_fetch_row($link)) {
                        ...
                        <td>$svg[1]</td>
                        <td>$svg[2]</td>
                        <td><a href= 'Controller/presentationController.php?id_presentation=$svg[0]'
                        onclick ='return confirmation();'> <img src='assets/img/supprimer.jpg' width='50' height='50'>
                        </a></td>
                        <td><a href='?ok=editpre&id_presentation=$svg[0]'><img src='assets/img/icone modifier.jpg' width='50' height='50'>
                        </a></td>
                            </tr>";
                    }
                ?>              
